...
public class WorkspaceService  implements IWorkspaceService {
    ...
    public void createWorkspace(CreateWorkSpaceRequest body) {
        try {
            if (body.getOwnerType()==null)
                throw new Exception("Owner type is required");
            if (body.getOwnerType().equals(RoleEnum.USER))
    ...
    public void updateWorkspace(UpdateWorkSpaceRequest body) {
        try {
            ...
            WorkspaceEntity workspaceEntity = workspaceRepository.findById(body.getId()).orElseThrow(() -> new Exception("Workspace not found"));
    ...
    public void addUserToWorkspace(CreateWorkspaceMemberRequest body) {
        try{
            ...
            WorkspaceMemberEntity workspaceMemberEntity = modelMapperService.mapClass(body, WorkspaceMemberEntity.class);
